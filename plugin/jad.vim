...
fun s:read(cmd)
  ...
  let jadfile = expand("<afile>:p:r") . ".jad"
  let orig    = expand("<afile>:p")
  "echom orig
  "echom jadfile
  ...
  g/.*/d
  "execute "silent r !" a:cmd . " -nonlb -b -ff -radix10 -t4 -space -lnc -p " . orig
  execute "silent r !" a:cmd . " -nonlb -b -ff -radix10 -t4 -space -pi8 -lnc -p " . orig
